...
//added by John Zhang
#define BD71805_REG_ALM_VBAT_TH_U	0x52
#define BD71805_REG_ALM_VBAT_TH_L	0x53
...
#define BD71805_REG_VM_SMA_VBAT_U	0x68
#define BD71805_REG_VM_SMA_VBAT_L	0x69
#define BD71805_REG_VM_SMA_IBAT_U	0x6A
#define BD71805_REG_VM_SMA_IBAT_L	0x6B
...
#define BD71805_REG_INT_STAT_03		0x97
#define BD71805_REG_INT_STAT_08		0x9C
...
enum {
	BD71805_INT_EN_01_BUCKAST_MASK	=	0x0F,
	BD71805_INT_EN_02_DCINAST_MASK	=	0x3E,
	BD71805_INT_EN_03_DCINAST_MASK	=	0x03,
	BD71805_INT_EN_04_VSYSAST_MASK	=	0xCF,
	BD71805_INT_EN_05_CHGAST_MASK	=	0xFC,
	BD71805_INT_EN_06_BATAST_MASK	=	0xF3,
	BD71805_INT_EN_07_BMONAST_MASK	=	0xFE,
	BD71805_INT_EN_08_BMONAST_MASK	=	0x03,
	BD71805_INT_EN_09_BMONAST_MASK	=	0x07,
	BD71805_INT_EN_10_BMONAST_MASK	=	0x3F,
	BD71805_INT_EN_11_TMPAST_MASK	=	0xFF,
	BD71805_INT_EN_12_ALMAST_MASK	=	0x07,
};
/* BD71805 interrupt irqs */
enum {
	BD71805_IRQ_BUCK_01		=	0x0,
	BD71805_IRQ_DCIN_02,
	BD71805_IRQ_DCIN_03,
	BD71805_IRQ_VSYS_04,
...
int bd71805_irq_init(struct bd71805 *bd71805, struct bd71805_board* bdinfo);
...
static inline int bd71805_reg_write(struct bd71805 *bd71805, u8 reg,
		unsigned int val)
{
	return bd71805->write(bd71805, reg, 1, &val);
}


extern int bd71805_update_bits(struct bd71805 *bd71805, u8 reg, u8 mask, u8 val);
...
static inline int bd71805_set_bits(struct bd71805 *bd71805, u8 reg,
		u8 mask)
{
	return bd71805_update_bits(bd71805, reg, mask, mask);
}
...
static inline int bd71805_clear_bits(struct bd71805 *bd71805, u8 reg,
		u8 mask)
{
	return bd71805_update_bits(bd71805, reg, mask, 0);
}
