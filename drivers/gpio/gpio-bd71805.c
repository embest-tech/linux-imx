...
static int __init gpio_bd71805_init(void)
{
	return platform_driver_register(&gpo_bd71805_driver);
}
subsys_initcall(gpio_bd71805_init);

static void __exit gpio_bd71805_exit(void)
{
	platform_driver_unregister(&gpo_bd71805_driver);
}
module_exit(gpio_bd71805_exit);
