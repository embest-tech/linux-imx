...
static u32 set_width, set_height;
...
static struct reg_value ov2656_setting_UGA_1600_1200[] = {
        /* reset */
        {0x3012,0x80, 0, 0},
        ...
        {0x3325,0x02, 0, 0},
        {0x3326,0xff, 0, 0},
        {0x3327,0x0c, 0, 0},   //ftm del test
        {0x3328,0x10, 0, 0},
        {0x3329,0x13, 0, 0},  //ftm add test

        {0x332a,0x58, 0, 0},
        {0x332b,0x5f, 0, 0},

        {0x332c,0xbe, 0, 0},
        {0x332d,0x9b, 0, 0},//ftm add test
        {0x332e,0x3a, 0, 0},

        {0x332f,0x36, 0, 0},
        {0x3330,0x4d, 0, 0},
        {0x3331,0x44, 0, 0},
        {0x3332,0xf0, 0, 0}, //ftm add test
...
static struct ov2656_mode_info ov2656_mode_info_data[ov2656_mode_MAX + 1] = {
	...
	{
		ov2656_mode_UGA_1600_1200, 1600, 1200,
		ov2656_setting_UGA_1600_1200,
		ARRAY_SIZE(ov2656_setting_UGA_1600_1200)
	},
};
...
static int ov2656_change_mode(enum ov2656_mode new_mode,  enum ov2656_mode orig_mode)
{
...
//	printk("----ov2656_change_mode new_mode= %d, orig_mode= %d\n",
//              new_mode, orig_mode);
	...
	if (new_mode == ov2656_mode_UGA_1600_1200 && orig_mode == ov2656_mode_VGA_640_480) {
        pModeSetting = ov2656_setting_UGA_1600_1200;
        iModeSettingArySize = ARRAY_SIZE(ov2656_setting_UGA_1600_1200);
        ov2656_data.pix.width = 1600;
        ov2656_data.pix.height = 1200;
    } else if (new_mode == ov2656_mode_VGA_640_480 && orig_mode == ov2656_mode_UGA_1600_1200) {
...
//	printk("----ioctl_s_parm\n");
	...
	case V4L2_BUF_TYPE_VIDEO_CAPTURE:
		...
		ret = ov2656_change_mode(a->parm.capture.capturemode, sensor->streamcap.capturemode);
		if (ret < 0)
			return ret;
