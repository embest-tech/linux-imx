...
static iomux_v3_cfg_t mx6q_marsboard_hdmi_ddc_pads[] = {
	MX6Q_PAD_KEY_COL3__HDMI_TX_DDC_SCL, /* HDMI DDC SCL */
	MX6Q_PAD_KEY_ROW3__HDMI_TX_DDC_SDA, /* HDMI DDC SDA */
};

static iomux_v3_cfg_t mx6q_marsboard_i2c2_pads[] = {
...
#if 0
static int mx6q_marsboard_spi_cs[] = {
	MX6Q_MARSBOARD_ECSPI1_CS1,
};

static const struct spi_imx_master mx6q_marsboard_spi_data __initconst = {
	.chipselect     = mx6q_marsboard_spi_cs,
	.num_chipselect = ARRAY_SIZE(mx6q_marsboard_spi_cs),
};
#endif
...
static struct spi_board_info imx6_marsboard_spi_nor_device[] __initdata = {
...
{
	spi_register_board_info(imx6_marsboard_spi_nor_device,
				ARRAY_SIZE(imx6_marsboard_spi_nor_device));
}
...
{
	if (powerdown)
		gpio_set_value(MX6Q_MARSBOARD_CSI0_PWN, 1);
	else
...
{
	mxc_iomux_v3_setup_multiple_pads(mx6q_marsboard_hdmi_ddc_pads,
		ARRAY_SIZE(mx6q_marsboard_hdmi_ddc_pads));
}

static void hdmi_disable_ddc_pin(void)
{
	mxc_iomux_v3_setup_multiple_pads(mx6q_marsboard_i2c2_pads,
		ARRAY_SIZE(mx6q_marsboard_i2c2_pads));
}
...
static void __init mx6_marsboard_board_init(void)
{
	...
	soc_reg_id = marsboard_dvfscore_data.soc_id;
	pu_reg_id = marsboard_dvfscore_data.pu_id;
 ...
 */
MACHINE_START(MX6Q_MARSBOARD, "Freescale i.MX 6Dual MarS Board")
